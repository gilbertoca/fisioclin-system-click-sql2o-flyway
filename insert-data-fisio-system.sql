...
-- ==========================================
INSERT INTO fisio.convenio (nome, cnpj) VALUES
...
-- ==========================================
INSERT INTO fisio.profissional (nome, crefito_ou_registro, telefone) VALUES
...
-- ==========================================
INSERT INTO fisio.modalidade (nome, duracao_minutos, valor_base) VALUES
...
INSERT INTO fisio.sessao (cliente_id, profissional_id, modalidade_id, data_hora_inicio, data_hora_fim, sessao_tipo, pagamento_origem, sessao_status, observacoes_recepcao) VALUES
...
INSERT INTO fisio.sessao_prontuario (sessao_id, queixa_subjetiva, avaliacao_objetiva, conduta_procedimento, plano_orientacoes) VALUES
(1,
...
INSERT INTO pagamento_sessao (sessao_id, valor_pago, situacao_financeira, data_pagamento, pagamento_meio) VALUES
...
--Faturamento
INSERT INTO faturamento (cliente_id, pagamento_origem, valor_total_faturado, faturamento_status, observacoes)
...
INSERT INTO recebimento_parcela (faturamento_id, numero_parcela, valor_parcela, data_vencimento, pagamento_status, data_pagamento, pagamento_meio)
