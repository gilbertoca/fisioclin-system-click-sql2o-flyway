...
-- ==========================================
INSERT INTO cliente (nome, cpf, data_nascimento, telefone, id_convenio, numero_carteirinha, status_clinico) VALUES
...
INSERT INTO sessao (id_cliente, id_profissional, id_modalidade, data_hora_inicio, data_hora_fim, tipo_sessao, tipo_pagamento, status_sessao, observacoes_recepcao) VALUES
...
-- ==========================================
-- Prontuário da Avaliação de RPG do Carlos (id_sessao = 1)
INSERT INTO prontuario_sessao (id_sessao, queixa_subjetiva, avaliacao_objetiva, conduta_procedimento, plano_orientacoes) VALUES
(1,
...
-- Prontuário da Avaliação de Fisioterapia da Ana Beatriz (id_sessao = 4)
INSERT INTO prontuario_sessao (id_sessao, queixa_subjetiva, avaliacao_objetiva, conduta_procedimento, plano_orientacoes) VALUES
(4,
...
-- Prontuário da Liberação Miofascial da Ana Beatriz (id_sessao = 5)
INSERT INTO prontuario_sessao (id_sessao, queixa_subjetiva, avaliacao_objetiva, conduta_procedimento, plano_orientacoes) VALUES
(5,
...
INSERT INTO pagamento_sessao (id_sessao, valor_pago, situacao_financeira, data_pagamento, forma_pagamento) VALUES
...
--Faturamento
INSERT INTO faturamento (id_cliente, tipo_faturamento, valor_total_faturado, status_faturamento, observacoes)
VALUES (2, 'PARTICULAR', 100.00, 'CONSOLIDADO', 'Massagem avulsa - Paga na recepção');
-- Retorna o id_faturamento gerado (Ex: ID 50)
INSERT INTO faturamento_item (id_faturamento, id_sessao, valor_item)
VALUES (50, 12, 100.00);
-- (Onde id_sessao 12 é a massagem que acabou de acontecer)
